...
def default_crcf() -> dict:
    ...
    return {
        ...
        "model_compliance_criteria": {
            ...
            "minimum_accuracy":          {**_BLANK_CRITERION, "bias": False, "pi": False, "r2": False},
        },
    }
...
def new_opc_record(opc_id: str, created_by: str, notes: str = "") -> dict:
    return {
        ...
        "uncertainty_propagation": {
            "initial_conditions": {"propagated": False, "propagation_method": ""},
            "drivers":            {"propagated": False, "propagation_method": ""},
            "parameters":         {"propagated": False, "propagation_method": ""},
            "management":         {"propagated": False, "propagation_method": ""},
            "process_error":      {"propagated": False, "propagation_method": ""},
            "random_effects":     {"propagated": False, "propagation_method": ""},
            "project_scale":      False,
        },
