...
| `opc_uncertainty_propagation.csv`      | `opc_id`, `opc_name`, then for each of the 6 sources: `<source>_propagated`, `<source>_method` (12 columns), plus `project_scale` — one row per OPC                                                                                                                                                                                                                                                  |
