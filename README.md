...
| -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `opc_factsheet.csv`                    | `opc_id`, `opc_name`, `opc_fullname`, `lead_institutions`\*, `main_modelling_approach`, `target_lusts`\*, `geographic_focus`\*, `ghgs_covered`\*, `crop_types_supported`\*, `cf_practices_covered`\*, `reporting_scale`\*, `update_frequency`, `user_orientation`\*, `operational_maturity`, `openness_level`, `validation_status`, `validation_status_notes`, `execution_targets`\*, `containerised`, `container_tech`\*, `requires_parallelisation`, `minimum_compute_notes`, `auto_data_ingestion`, `auto_preprocessing`, `auto_model_execution`, `auto_qa_qc`, `auto_report_generation`, `input_interfaces`\*, `output_formats`\*, `integrates_with_fmis`, `integrates_with_lpis`, `integrates_with_lab_data`, `integrates_with_eo_pipeline`, `machine_readable_io_schema`, `requires_field_management_data`, `requires_soil_sampling`, `requires_lab_analysis`, `requires_optical_eo`, `requires_sar_eo`, `requires_weather_data`, `most_critical_bottleneck`, `schema_version`, `last_updated` |
